...
```{r}
ggplot(competitions, aes(x=hill_size_x, color=gender)) +
  geom_histogram(aes(y = ..density..),fill="white", alpha = 0.6, position="identity",binwidth=20, breaks=c(60,85,115,160,250))
```

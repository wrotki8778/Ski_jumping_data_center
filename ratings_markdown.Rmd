...
peak_ratings %>% mutate(name=fct_reorder(name,cumm_rating,sum)) %>% ggplot(aes(name,cumm_rating, fill=date)) + geom_bar(stat='identity') + labs(title=tmp_title)+coord_flip()
```
